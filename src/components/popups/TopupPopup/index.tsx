      ...
      {topupOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed bottom-0 left-0 right-0 bg-black rounded-t-[34px] border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.85)] z-[100] pt-5 pb-[calc(2.5rem+env(safe-area-inset-bottom))] flex flex-col overflow-hidden max-h-[92vh]"
          >
            {/* Handle */}
