  ...
  return (
    <div className="flex flex-col items-center justify-center pt-8 px-4 text-center">
      ...
      >
        ...
        <h2 className="text-2xl font-black text-white italic mb-2">WATCH ADS</h2>
        <p className="text-white/60 font-medium mb-8">
          Support us and earn extra rewards by watching short video ads!
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-black/40 rounded-2xl p-4 border border-white/5">
            ...
            <div className="text-white/40 text-xs font-bold">STARS</div>
          </div>
        </div>
